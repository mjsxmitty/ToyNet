...
#ifndef __CPP_PRIMER_CHAPTER_07_PERSON_H__
#define __CPP_PRIMER_CHAPTER_07_PERSON_H__
...
public:
    Person() = default;
    Person(const std::string &name, const std::string &addr) : name_(name), address_(addr) {}
...
#endif // __CPP_PRIMER_CHAPTER_07_PERSON_H__
